  ...
  <div class="container">
    ...
    <form class="card" @submit.prevent="submitForm">
      ...
      <ol>
        ...
        <li v-for="question in questions.basicQuestions" :key="question.id">
          <AppText
        ...
        <div v-if="form.headacheToday === 'yes'">
          <li v-for="question in questions.headacheQuestions" :key="question.id">
            <AppRadio
              v-if="question.type === 'radio'"
              v-model="form[question.model]"
              :label="question.label"
        ...
        <div v-if="form.medication === 'yes'">
          <li v-for="question in questions.drugQuestions" :key="question.id">
            <AppText
              v-if="question.type === 'text'"
              v-model="form[question.model]"
              :label="question.label"
